...
interface BullosseumInterface extends ethers.utils.Interface {
  functions: {
...
export class Bullosseum extends BaseContract {
  ...
  functions: {
    ...
    getAddrOfBAF(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getAddrOfBAF(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAddrOfBAF(overrides?: CallOverrides): Promise<PopulatedTransaction>;
