...
interface JungleFieldsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getJunglerOnField(uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getJunglerOnField",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export type CurrentJunglerStateEvent = TypedEvent<
  [
    ...
    id: BigNumber;
    data: [number, boolean, boolean, BigNumber, string, BigNumber, number] & {
      generation: number;
      closed: boolean;
      onField: boolean;
      power: BigNumber;
...
export class JungleFields extends BaseContract {
  ...
  interface: JungleFieldsInterface;
