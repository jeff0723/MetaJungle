...
interface BullosseumInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class BullosseumInterface extends BaseContract {
  ...
  interface: BullosseumInterfaceInterface;
