...
interface BullsToTheMoonCoreInterface extends ethers.utils.Interface {
  functions: {
...
export class BullsToTheMoonCore extends BaseContract {
  ...
  interface: BullsToTheMoonCoreInterface;
