...
interface BullsToTheMoonGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class BullsToTheMoonGovernance extends BaseContract {
  ...
  interface: BullsToTheMoonGovernanceInterface;
