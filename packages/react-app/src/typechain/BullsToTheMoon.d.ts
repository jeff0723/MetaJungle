...
interface BullsToTheMoonInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getMagicGrassAddr()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getMagicGrassAddr",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class BullsToTheMoon extends BaseContract {
  ...
  functions: {
    ...
    getMagicGrassAddr(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getMagicGrassAddr(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getMagicGrassAddr(overrides?: CallOverrides): Promise<PopulatedTransaction>;
