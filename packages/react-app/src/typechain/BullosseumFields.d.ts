...
interface BullosseumFieldsInterface extends ethers.utils.Interface {
  functions: {
...
export class BullosseumFields extends BaseContract {
  ...
  interface: BullosseumFieldsInterface;
