...
interface BullosseumFighterInterface extends ethers.utils.Interface {
  functions: {
...
export class BullosseumFighter extends BaseContract {
  ...
  interface: BullosseumFighterInterface;
