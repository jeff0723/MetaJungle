...
interface BullosseumGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class BullosseumGovernance extends BaseContract {
  ...
  interface: BullosseumGovernanceInterface;
